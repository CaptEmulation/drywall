...
var createObjectFinder = function () {
  var foundObjs = [];
  ...
  var self = {
    ...
    promiseFind: function () {
      var defer = Q.defer();
      defer.resolve(foundObjs);
...
describe('controller test suite', function () {
  ...
  var test, proxyFind, clientFind, serverSocket, serverSocket2, clientSocket;
  ...
  beforeEach(function () {
    ...
    proxyFind = createObjectFinder();
    clientFind = createObjectFinder();
    ...
    controller.__set__('findProxies', proxyFind.promiseFind);
    controller.__set__('findClients', clientFind.promiseFind);
